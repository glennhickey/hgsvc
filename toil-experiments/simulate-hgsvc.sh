...
CMD="sim aws:${REGION}:${JOBSTORE_NAME} s3://vg-data/HGSVC/HGSVC.chroms_HG00514_haplo_thread_0.xg  s3://vg-data/HGSVC/HGSVC.chroms_HG00514_haplo_thread_1.xg 256000000  aws:${REGION}:${OUTSTORE_NAME} --out_name sim-HG00514-30x --gam --fastq_out --fastq  ${TEMPLATE_PATH} --sim_opts \"-p 570 -v 165 -i 0.002 -I\" --sim_chunks 100 --seed 1 --whole_genome_config --logFile simulate.hgsvc.log"
